...
export class TeamComponent implements OnInit {
  ...
  teams = [
    ...
    },
    {
      ...
      description: 'Запознахме се с Илиян по предпоръка на Симон. Видяхме съвместната им работа и разбрахме, че синхронът между екипът е много важен. След като се сещнахме с него опознахме по отблизо професионализмът му и бяхме възхитени от произведенията му на изкъсвтото.',
