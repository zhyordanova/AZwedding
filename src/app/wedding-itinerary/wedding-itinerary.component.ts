  ...
  infos = [
    {
      ...
      transport: `Следните линии имат маршрути, които минават в близо до „Св. София“: \nАвтобус: 204, 280, 304, 309, 604, 94\n Метро: М1, М3, М4\nТрамвай: 22\nTролейбус: 3, 4, 9`,
    ...
    },
    {
      ...
      goodToKnow: 'В залата не е разрешено тютюнопушенето. За да може да пушите ще се наложи да слезете на централният вход, които е два етажа по надолу. Нашият съвет е да се заредите с предпочитан от вас, електронен заместител като например IQOS или електронно наргиле, които са позволени за употреба в целият хотел.'
    }
  ]
